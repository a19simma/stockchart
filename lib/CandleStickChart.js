...
export class CandleStickChart {
  ...
  addCandle(n = 1) {
    console.log(this.pastCandles, this.visibleCandles);
  ...
  setSize({ width, height }) {
    ...
    if (this.canvas != undefined) this.setContextSizes();
  }

  setContextSizes() {
    this.canvas.width = this.width - this.barWidth;
    this.canvas.height = this.height - this.barWidth;
